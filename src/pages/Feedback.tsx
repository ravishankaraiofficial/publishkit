          ...
          <div className="space-y-6">
            {items.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="bg-[#1A1A1A] border border-[#2A2A2A] hover:border-[#E05A1E]/30 transition-all rounded-2xl p-4 sm:p-6"
                >
                  {/* Main feedback */}
                    ...
                    {isReplyExpanded && (
                      <div className="space-y-3 mb-3">
                        {itemReplies.map(reply => (
                          <div key={reply.id} className="bg-[#0D0D0D] rounded-xl p-3 ml-4">
                            <div className="flex items-center gap-2 mb-1">
                              <div className="w-5 h-5 rounded-full bg-[#2A2A2A] flex items-center justify-center text-[9px] text-white font-bold">
                                {reply.userName?.[0]}
                              </div>
                              <span className="text-xs font-medium text-[#888888]">{reply.userName}</span>
