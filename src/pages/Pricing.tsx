...
const Pricing: React.FC = () => {
  ...
  const plans: Record<string, {
    ...
    ultra: {
      ...
      limit: 300,
      features: [
        { key: 'pricing.feat.metadataN', params: { count: 300 }, included: true },
        { key: 'pricing.feat.allOutputs', included: true },
        { key: 'pricing.feat.languageSupport', included: true },
        { key: 'pricing.feat.scriptN', params: { count: 300 }, included: true },
        { key: 'pricing.feat.multipostN', params: { count: 300 }, included: true },
